    ...
    <div class="view-container">
        ...
        <div class="content">
            ...
            <div class="content-text3" ref="target3">
                ...
                このように標準写像のような保存系(写像のヤコビ行列式が1となる力学系)では、不変曲線の破壊や楕円状の曲線島の形成、\( \varepsilon \ \)を大きくしたときの砂粒のようなカオスの海が特徴的に見られます。
                力学形では不変集合ごとに系を分けて、それぞれの構造を調べることで元の力学系の構造を調べることができ、不変曲線(上下横断するもの)によって不変集合は区切られるためKAM定理は、系全体の数理構造を知ることが出来ます。
                <br><br>
