			...
			<div class="container">
				<div class="text-container" data-title="WELCOME TO MY PORTFOLIO SITE!">
					<div class="text">
						...
						学生時代ではよく夜遅くまで友人とものづくりをし、こだわりたい部分を作るためにずっと調べものをしながらトライアルアンドエラーを繰り返し、様々なものを作りました。そのため、ものづくりに対する集中力と忍耐力は自信があります。
						また、高専時代では実践的な経験を多く積み、大学では数学や物理学、情報学などの基礎理論を深く学び、これから先の技術の変化についていける下地を身につけています。
						<br>
						<br>
